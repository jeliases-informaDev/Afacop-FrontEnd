...
const AvatarTagComponent = /*#__PURE__*/forwardRef(function AvatarTag({
  ...
  const onShrinkOutExitComplete = useCallback(() => {
    onAfterRemoveAction === null || onAfterRemoveAction === void 0 ? void 0 : onAfterRemoveAction(text);
  ...
  const AvatarComponentTyped = AvatarComponent;
  const rendered = /*#__PURE__*/React.createElement(AvatarComponentTyped, controlledProps);
  const avatarElement =
