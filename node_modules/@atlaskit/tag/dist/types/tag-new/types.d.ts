...
import type { BackgroundColor, BackgroundColorHovered, BackgroundColorPressed } from '@atlaskit/tokens/css-type-schema';
export type NewTagColor = 'gray' | 'blue' | 'red' | 'yellow' | 'green' | 'teal' | 'purple' | 'lime' | 'orange' | 'magenta';
export interface TagNewProps {
     ...
     */
    onClick?: ((e: React.MouseEvent<HTMLAnchorElement>, analyticsEvent: UIAnalyticsEvent) => void) | ((e: React.MouseEvent<HTMLButtonElement>, analyticsEvent?: UIAnalyticsEvent) => void);
    /**
...
export type TagSwatchBeforeTokenName = BackgroundColor | BackgroundColorHovered | BackgroundColorPressed;
/**
 ...
 */
export type TagDropdownTriggerProps = Omit<TagNewProps, 'isRemovable' | 'onBeforeRemoveAction' | 'onAfterRemoveAction' | 'removeButtonLabel' | 'href' | 'linkComponent' | 'onClick'> & {
    /**
