 ...
 *
 */
declare const RemovableTag: import('react').MemoExoticComponent<import('react').ForwardRefExoticComponent<Omit<RemovableTagProps, 'ref'> & import('react').RefAttributes<any>>>;
