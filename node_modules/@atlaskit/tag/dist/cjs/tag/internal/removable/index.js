...
var _colorMapping = require("../../../tag-new/color-mapping");
var _getTagText = require("../../../tag-new/get-tag-text");
var _tagNew = _interopRequireDefault(require("../../../tag-new/tag-new"));
var _base = _interopRequireDefault(require("../shared/base"));
var _before = _interopRequireDefault(require("../shared/before"));
var _colorToLozengeAppearance = require("../shared/color-to-lozenge-appearance");
var _content = _interopRequireDefault(require("../shared/content"));
var _removeButton = _interopRequireDefault(require("./remove-button"));
var _excluded = ["appearance", "elemBefore", "isRemovable", "text", "color", "href", "removeButtonLabel", "testId", "onBeforeRemoveAction", "onAfterRemoveAction", "linkComponent", "migration_fallback", "maxWidth", "hasMargin", "swatchBefore", "swatchBeforeLabel", "swatchBeforeRole"];
...
var RemovableTagComponent = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  var appearance = _ref.appearance,
    ...
    migration_fallback = _ref.migration_fallback,
  ...
  var removeButton = isRemovable ? /*#__PURE__*/React.createElement(_removeButton.default, {
    "aria-label": "".concat(removeButtonLabel || 'Remove', " ").concat(normalizedText),
  ...
  if (migration_fallback === 'lozenge' && !(0, _platformFeatureFlags.fg)('platform-dst-lozenge-tag-badge-visual-uplifts')) {
    var lozengeAppearance = (0, _colorToLozengeAppearance.getLozengeAppearance)(color);
    return /*#__PURE__*/React.createElement(_lozenge.default, (0, _extends2.default)({
  ...
  if ((0, _platformFeatureFlags.fg)('platform-dst-lozenge-tag-badge-visual-uplifts')) {
    var newColor = _colorMapping.colorMapping[color || 'standard'];
    return /*#__PURE__*/React.createElement(_tagNew.default, (0, _extends2.default)({
      ref: ref,
      color: newColor,
      text: normalizedText,
    ...
    }, (0, _platformFeatureFlags.fg)('parent-field-switcher-missing-info-image-text') ? {
  ...
  }, backgroundHoverCssVar, undefined), backgroundActiveCssVar, undefined), textDefaultCssVar, undefined), textActiveCssVar, undefined), textLinkCssVar, undefined);
  return /*#__PURE__*/React.createElement(_motion.ExitingPersistence, null, !(status === TagStatus.Removed) && /*#__PURE__*/React.createElement(_motion.ShrinkOut, {
