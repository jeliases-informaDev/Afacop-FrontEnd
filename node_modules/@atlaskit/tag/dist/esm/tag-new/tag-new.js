/* tag-new.tsx generated by @compiled/babel-plugin v2.0.0 */
...
var styles = {
  baseStyles: "_zulp1b66 _2rko12b0 _11c8wadc _1dqonqa1 _189ee4h9 _1rjcv77o _18zr1mie _1mou1b66 _195g1b66 _1e0c116y _vchhusvi _1ul9idpf _p12ff6dh _4t3i1k92 _kqswh2mm _4cvr1h6o _80om73ad _bfhksm61",
 ...
 */
var TagNewComponent = /*#__PURE__*/forwardRef(function TagNew(_ref, ref) {
  ...
  var normalizedText = getTagText(text);
  var _useTagRemoval = useTagRemoval(onBeforeRemoveAction),
  ...
  var removeButton = useRemoveButton({
  ...
  var tagContent = /*#__PURE__*/React.createElement("span", _extends({}, other, {
    ref: ref,
    "data-testid": testId
    ...
    className: ax([styles.baseStyles, !hasMargin && styles.noMarginStyles, colorStyles[color], borderIconFilterStyles.root, isLink && styles.interactiveBaseStyles, isLink && styles.focusRingStyles, isLink && isLinkHovered && !isOverButton && borderIconInteractiveFilterStyles.root, isLink && isLinkHovered && !isOverButton && styles.interactiveHoverStyles, isRemovable && styles.removableStyles, isLinkFocused && !isButtonFocused && styles.childFocusRingStyles, !isRemovable && trailingMetric != null && trailingMetric !== '' && styles.trailingMetricEndPadding])
    ...
    onClick: onClick
  }, /*#__PURE__*/React.createElement(SwatchBefore, _extends({
    colorKey: color,
    ...
    className: ax([styles.trailingMetric])
 ...
 * or dropdown menu.
 */
export var TagDropdownTriggerComponent = /*#__PURE__*/forwardRef(function TagDropdownTrigger(_ref2, ref) {
  var _ref2$color = _ref2.color,
    ...
    _ref2$hasMargin = _ref2.hasMargin,
    hasMargin = _ref2$hasMargin === void 0 ? true : _ref2$hasMargin,
    onClick = _ref2.onClick,
    _ref2$isSelected = _ref2.isSelected,
    isSelected = _ref2$isSelected === void 0 ? false : _ref2$isSelected,
    _ref2$isLoading = _ref2.isLoading,
    isLoading = _ref2$isLoading === void 0 ? false : _ref2$isLoading,
    _analyticsContext = _ref2.analyticsContext,
    _ref2$hasChevron = _ref2.hasChevron,
    hasChevron = _ref2$hasChevron === void 0 ? true : _ref2$hasChevron,
    swatchBefore = _ref2.swatchBefore,
    swatchBeforeLabel = _ref2.swatchBeforeLabel,
    swatchBeforeRole = _ref2.swatchBeforeRole,
    trailingMetric = _ref2.trailingMetric,
    other = _objectWithoutProperties(_ref2, _excluded2);
  var resolvedColor = colorMapping[color] || 'gray';
  return /*#__PURE__*/React.createElement(Pressable, _extends({
    ref: ref
    // @ts-expect-error paddingInline is 0.1875rem
    // eslint-disable-next-line @compiled/no-suppress-xcss
    ,
    xcss: cx(styles.baseStyles, !hasMargin && styles.noMarginStyles, colorStyles[resolvedColor], borderIconFilterStyles.root, dropdownStyles.interactive, styles.focusRingStyles, borderIconInteractiveFilterStyles.root, isSelected && dropdownStyles.selected,
    ...
    className: ax([dropdownStyles.content, isLoading && dropdownStyles.loadingContent])
  }, /*#__PURE__*/React.createElement(SwatchBefore, _extends({
    ...
    className: ax([styles.beforeStyles, isSelected && styles.beforeStylesSelected])
  }, elemBefore), /*#__PURE__*/React.createElement("span", {
    "data-tag-text": true,
    className: ax([styles.textStyles, isSelected && styles.textStylesSelected])
  }, getTagText(text)), trailingMetric != null && trailingMetric !== '' && /*#__PURE__*/React.createElement("span", {
    "data-testid": testId && "".concat(testId, "--metric"),
    className: ax([styles.trailingMetric])
  }, trailingMetric), hasChevron && /*#__PURE__*/React.createElement(ChevronDownIcon, {
    label: "",
    size: "small",
    color: 'currentColor',
    testId: testId && "".concat(testId, "--chevron")
  })), isLoading && /*#__PURE__*/React.createElement("span", {
    className: ax([dropdownStyles.loadingOverlay])
 ...
 * __Tag new__
 */
var TagNew = /*#__PURE__*/memo(TagNewComponent);
