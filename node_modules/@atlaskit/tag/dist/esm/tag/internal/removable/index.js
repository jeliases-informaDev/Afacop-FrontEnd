...
var RemovableTagComponent = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  if (migration_fallback === 'lozenge' && !fg('platform-dst-lozenge-tag-badge-visual-uplifts')) {
    var lozengeAppearance = getLozengeAppearance(color);
  ...
  if (fg('platform-dst-lozenge-tag-badge-visual-uplifts')) {
    var newColor = colorMapping[color || 'standard'];
