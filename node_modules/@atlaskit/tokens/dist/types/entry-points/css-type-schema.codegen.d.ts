...
export type BorderColor = 'transparent' | 'var(--ds-border)' | 'var(--ds-border-accent-lime)' | 'var(--ds-border-accent-lime-subtle)' | 'var(--ds-border-accent-red)' | 'var(--ds-border-accent-red-subtle)' | 'var(--ds-border-accent-orange)' | 'var(--ds-border-accent-orange-subtle)' | 'var(--ds-border-accent-yellow)' | 'var(--ds-border-accent-yellow-subtle)' | 'var(--ds-border-accent-green)' | 'var(--ds-border-accent-green-subtle)' | 'var(--ds-border-accent-teal)' | 'var(--ds-border-accent-teal-subtle)' | 'var(--ds-border-accent-blue)' | 'var(--ds-border-accent-blue-subtle)' | 'var(--ds-border-accent-purple)' | 'var(--ds-border-accent-purple-subtle)' | 'var(--ds-border-accent-magenta)' | 'var(--ds-border-accent-magenta-subtle)' | 'var(--ds-border-accent-gray)' | 'var(--ds-border-accent-gray-subtle)' | 'var(--ds-border-code)' | 'var(--ds-border-disabled)' | 'var(--ds-border-focused)' | 'var(--ds-border-input)' | 'var(--ds-border-inverse)' | 'var(--ds-border-selected)' | 'var(--ds-border-brand)' | 'var(--ds-border-danger)' | 'var(--ds-border-danger-subtle)' | 'var(--ds-border-warning)' | 'var(--ds-border-warning-subtle)' | 'var(--ds-border-success)' | 'var(--ds-border-success-subtle)' | 'var(--ds-border-discovery)' | 'var(--ds-border-discovery-subtle)' | 'var(--ds-border-information)' | 'var(--ds-border-information-subtle)' | 'var(--ds-border-bold)' | 'var(--ds-rovo-border-lime)' | 'var(--ds-rovo-border-saffron)' | 'var(--ds-rovo-border-blue)' | 'var(--ds-rovo-border-purple)';
...
export type TextColor = 'transparent' | TextColorPressed | 'var(--ds-text)' | 'var(--ds-text-accent-lime)' | 'var(--ds-text-accent-lime-bolder)' | 'var(--ds-text-accent-red)' | 'var(--ds-text-accent-red-bolder)' | 'var(--ds-text-accent-orange)' | 'var(--ds-text-accent-orange-bolder)' | 'var(--ds-text-accent-yellow)' | 'var(--ds-text-accent-yellow-bolder)' | 'var(--ds-text-accent-green)' | 'var(--ds-text-accent-green-bolder)' | 'var(--ds-text-accent-teal)' | 'var(--ds-text-accent-teal-bolder)' | 'var(--ds-text-accent-blue)' | 'var(--ds-text-accent-blue-bolder)' | 'var(--ds-text-accent-purple)' | 'var(--ds-text-accent-purple-bolder)' | 'var(--ds-text-accent-magenta)' | 'var(--ds-text-accent-magenta-bolder)' | 'var(--ds-text-accent-gray)' | 'var(--ds-text-accent-gray-bolder)' | 'var(--ds-text-code-accent-1)' | 'var(--ds-text-code-accent-2)' | 'var(--ds-text-code-comments)' | 'var(--ds-text-code-default)' | 'var(--ds-text-code-functions)' | 'var(--ds-text-code-gutter)' | 'var(--ds-text-code-keywords)' | 'var(--ds-text-code-numbers)' | 'var(--ds-text-code-operators)' | 'var(--ds-text-code-strings)' | 'var(--ds-text-code-tags)' | 'var(--ds-text-disabled)' | 'var(--ds-text-inverse)' | 'var(--ds-text-selected)' | 'var(--ds-text-brand)' | 'var(--ds-text-danger)' | 'var(--ds-text-danger-bolder)' | 'var(--ds-text-warning)' | 'var(--ds-text-warning-inverse)' | 'var(--ds-text-warning-bolder)' | 'var(--ds-text-success)' | 'var(--ds-text-success-bolder)' | 'var(--ds-text-discovery)' | 'var(--ds-text-discovery-bolder)' | 'var(--ds-text-information)' | 'var(--ds-text-information-bolder)' | 'var(--ds-text-subtlest)' | 'var(--ds-text-subtle)' | 'var(--ds-link)' | 'var(--ds-link-visited)';
...
export type Motion = 'var(--ds-avatar-enter)' | 'var(--ds-avatar-exit)' | 'var(--ds-avatar-hovered)' | 'var(--ds-blanket-enter)' | 'var(--ds-blanket-exit)' | 'var(--ds-button-hovered)' | 'var(--ds-button-pressed)' | 'var(--ds-flag-enter)' | 'var(--ds-flag-exit)' | 'var(--ds-flag-reposition)' | 'var(--ds-listitem-hovered)' | 'var(--ds-listitem-pressed)' | 'var(--ds-listitem-selected)' | 'var(--ds-modal-enter)' | 'var(--ds-modal-exit)' | 'var(--ds-panel-enter)' | 'var(--ds-panel-exit)' | 'var(--ds-popup-enter-bottom)' | 'var(--ds-popup-enter-left)' | 'var(--ds-popup-enter-right)' | 'var(--ds-popup-enter-top)' | 'var(--ds-popup-exit-bottom)' | 'var(--ds-popup-exit-left)' | 'var(--ds-popup-exit-right)' | 'var(--ds-popup-exit-top)' | 'var(--ds-sidenav-enter-left)' | 'var(--ds-sidenav-enter-right)' | 'var(--ds-sidenav-exit-left)' | 'var(--ds-sidenav-exit-right)' | 'var(--ds-spotlight-enter)' | 'var(--ds-spotlight-exit)';
