...
var AnalyticsErrorBoundary = exports.default = /*#__PURE__*/function (_Component) {
  function AnalyticsErrorBoundary(props) {
    ...
    // Gated by analytics-next-lock-context-type(-all-afm): keep the value captured at construction so a late gate flip can't swap the context type and remount the subtree.
    (0, _defineProperty2.default)(_this, "lockedIsModernContext", _isModernContextEnabledEnv.default || (0, _platformFeatureFlags.fg)('analytics-next-use-legacy-context') === false);
    _this.state = {
      hasError: false
    };
    return _this;
  ...
  return (0, _createClass2.default)(AnalyticsErrorBoundary, [{
    ...
    value: function render() {
      ...
      var isModernContext = isLockContextTypeAllAfm || isLockContextType ? this.lockedIsModernContext : _isModernContextEnabledEnv.default || (0, _platformFeatureFlags.fg)('analytics-next-use-legacy-context') === false;
      if (hasError) {
        if (ErrorComponent) {
          if (isModernContext) {
