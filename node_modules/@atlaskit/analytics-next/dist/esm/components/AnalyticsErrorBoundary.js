...
var AnalyticsErrorBoundary = /*#__PURE__*/function (_Component) {
  function AnalyticsErrorBoundary(props) {
    ...
    _defineProperty(_this, "lockedIsModernContext", isModernContextEnabledEnv || fg('analytics-next-use-legacy-context') === false);
    _this.state = {
      hasError: false
    };
    return _this;
  ...
  return _createClass(AnalyticsErrorBoundary, [{
    ...
    value: function render() {
      ...
      var isModernContext = isLockContextTypeAllAfm || isLockContextType ? this.lockedIsModernContext : isModernContextEnabledEnv || fg('analytics-next-use-legacy-context') === false;
      if (hasError) {
        if (ErrorComponent) {
          if (isModernContext) {
