 ...
 * ```
 */
export function useArrowNavigation(_ref) {
  var containerRef = _ref.containerRef,
    onClose = _ref.onClose,
    onNestedOpen = _ref.onNestedOpen,
    onNestedClose = _ref.onNestedClose,
  ...
  var handleKeyDown = useCallback(function (event) {
    ...
    var focused = (_getDocument = getDocument()) === null || _getDocument === void 0 ? void 0 : _getDocument.activeElement;
    ...
    if (event.key === KEY_DOWN) {
      ...
      (_getNextFocusable = getNextFocusable({
        ...
        direction: 'forwards',
        filter: filter
      })) === null || _getNextFocusable === void 0 || _getNextFocusable.focus();
      return;
    }
    if (event.key === KEY_UP) {
      ...
      (_getNextFocusable2 = getNextFocusable({
        ...
        direction: 'backwards',
        filter: filter
      })) === null || _getNextFocusable2 === void 0 || _getNextFocusable2.focus();
      return;
    }
    if (event.key === KEY_HOME) {
      ...
      (_getFirstFocusable = getFirstFocusable({
        container: container,
        filter: filter
      })) === null || _getFirstFocusable === void 0 || _getFirstFocusable.focus();
      return;
    }
    if (event.key === KEY_END) {
      ...
      (_getLastFocusable = getLastFocusable({
        container: container,
        filter: filter
      })) === null || _getLastFocusable === void 0 || _getLastFocusable.focus();
      return;
    }
    ...
    if (event.key === 'ArrowLeft') {
      if (onNestedClose) {
        ...
        var isNested = ((_container$parentElem = container.parentElement) === null || _container$parentElem === void 0 ? void 0 : _container$parentElem.closest(menuScope)) !== null;
        if (isNested) {
          event.preventDefault();
          onNestedClose();
        }
