 ...
 */
function applyStaticAnchorStyles(element) {
 ...
 * ```
 */
export function useAnchorPositionAtPoint(_ref) {
  var popoverRef = _ref.popoverRef,
    placement = _ref.placement,
    getPoint = _ref.getPoint,
    _ref$isEnabled = _ref.isEnabled,
    isEnabled = _ref$isEnabled === void 0 ? true : _ref$isEnabled,
    isOpen = _ref.isOpen;
  var syntheticAnchorRef = useRef(null);
  ...
  var getPointRef = useRef(getPoint);
  ...
  useLayoutEffect(function () {
    ...
    anchor.style.top = "".concat(point.y, "px");
    anchor.style.left = "".concat(point.x, "px");
