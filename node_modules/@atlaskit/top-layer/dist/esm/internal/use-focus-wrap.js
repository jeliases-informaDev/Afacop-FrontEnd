 ...
 */
function roleRequiresFocusWrap(role) {
 ...
 */
export function useFocusWrap(_ref) {
  ...
  useEffect(function () {
    ...
    var unbind = bind(element, {
      ...
      listener: function listener(event) {
        ...
        var fallback = direction === 'forwards' ? getFirstFocusable({
          container: element
        }) : getLastFocusable({
          container: element
        });
