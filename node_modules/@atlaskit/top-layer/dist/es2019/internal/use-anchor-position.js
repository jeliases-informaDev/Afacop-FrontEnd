 ...
 */
const supportsAnchorPositioning = once(() => {
...
export function useAnchorPosition({
  ...
  useLayoutEffect(() => {
    ...
    if (supportsAnchorPositioning() && !shouldForceFallback) {
      ...
      const anchorName = trigger.style.getPropertyValue('anchor-name') || `--anchor-${id.replace(/:/g, '')}`;
      ...
      const popoverStyles = [{
        ...
        value: placementToPositionArea({
          placement: stablePlacement
        })
      }, {
        property: 'position-try-fallbacks',
        value: placementToTryFallbacks({
          placement: stablePlacement
        })
      },
      ...
      const customPropertyByMarginProperty = {
      ...
      const crossAxisShiftCustomProperty = customPropertyByMarginProperty[crossAxisShiftActive.property];
      ...
      const undoPositioning = combine(setStyle({
        element: popover,
    ...
    const ResizeObserverImpl = typeof ResizeObserver !== 'undefined' ? ResizeObserver : NoopResizeObserver;
    ...
    const undoPositioning = combine(cleanupBaseStyles,
    ...
    }), () => resizeObserver.disconnect(), bind(window, {
      type: 'scroll',
