...
export function useAnimatedVisibility({
  ...
  useEffect(() => {
    ...
    return runOnTransitionEndOrTimeout({
      ...
      onSettled: () => {
        ...
        // semantics.
        (_onEnterFinishRef$cur = onEnterFinishRef.current) === null || _onEnterFinishRef$cur === void 0 ? void 0 : _onEnterFinishRef$cur.call(onEnterFinishRef);
  ...
  const prevPhaseForEntryRef = useRef('closed');
  useEffect(() => {
    ...
    if (prevPhase !== 'open' && phase === 'open' && prevPhase !== 'entering') {
      ...
      (_onEnterFinishRef$cur2 = onEnterFinishRef.current) === null || _onEnterFinishRef$cur2 === void 0 ? void 0 : _onEnterFinishRef$cur2.call(onEnterFinishRef);
    }
  }, [phase]);
  ...
  useEffect(() => {
    ...
    return runOnTransitionEndOrTimeout({
      ...
      onSettled: () => {
        ...
        (_onExitFinishRef$curr = onExitFinishRef.current) === null || _onExitFinishRef$curr === void 0 ? void 0 : _onExitFinishRef$curr.call(onExitFinishRef);
  ...
  const prevPhaseForExitRef = useRef('closed');
  useEffect(() => {
    ...
    if (prevPhase !== 'exiting' && phase === 'exiting' && !willAnimate) {
      ...
      (_onExitFinishRef$curr2 = onExitFinishRef.current) === null || _onExitFinishRef$curr2 === void 0 ? void 0 : _onExitFinishRef$curr2.call(onExitFinishRef);
    }
  }, [phase, willAnimate]);
  return {
    phase
