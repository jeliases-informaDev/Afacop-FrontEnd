...
export function useWidthFromAnchor({
  ...
  useLayoutEffect(() => {
    ...
    const supportsAnchorSize = typeof CSS !== 'undefined' && typeof CSS.supports === 'function' && CSS.supports('width', 'anchor-size(width)');
