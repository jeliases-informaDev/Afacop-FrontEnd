...
exports.fromLegacyPlacement = fromLegacyPlacement;
var _defineProperty2 = _interopRequireDefault(require("@babel/runtime/helpers/defineProperty"));
var _slicedToArray2 = _interopRequireDefault(require("@babel/runtime/helpers/slicedToArray"));
var _placementMapping = require("./placement-mapping");
 ...
 * ```
 */
function fromLegacyPlacement(_ref) {
  var legacy = _ref.legacy,
    offset = _ref.offset;
  var basePlacement = _placementMapping.placementMapping[legacy];
  if (!offset) {
  ...
  var _offset = (0, _slicedToArray2.default)(offset, 2),
    along = _offset[0],
    away = _offset[1];
  return _objectSpread(_objectSpread({}, basePlacement), {}, {
    offset: {
      gap: away,
      crossAxisShift: {
