...
exports.useSimpleLightDismiss = useSimpleLightDismiss;
 ...
 */
function useSimpleLightDismiss(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var unbindEscape = (0, _bindEventListener.bind)(document, {
      type: 'keydown',
    ...
    // eslint-disable-next-line @atlaskit/platform/no-direct-document-usage -- binding to document for light dismiss
    var unbindClickOutside = (0, _bindEventListener.bind)(document, {
      type: 'click',
      listener: function listener(event) {
