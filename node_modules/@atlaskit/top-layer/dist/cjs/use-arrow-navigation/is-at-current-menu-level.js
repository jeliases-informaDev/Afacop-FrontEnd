...
exports.isAtCurrentMenuLevel = isAtCurrentMenuLevel;
 ...
 */
function reachesContainerWithoutNestedMenu(node, container) {
 ...
 */
function isAtCurrentMenuLevel(element, container) {
  var closestMenu = element.closest(menuScope);
