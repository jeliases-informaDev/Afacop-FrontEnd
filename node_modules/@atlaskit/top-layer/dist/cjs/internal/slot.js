 ...
 * ```
 */
var Slot = exports.Slot = /*#__PURE__*/(0, _react.forwardRef)(function Slot(slotProps, ref) {
  var rawChildren = slotProps.children,
    props = (0, _objectWithoutProperties2.default)(slotProps, _excluded);
  ...
  return /*#__PURE__*/(0, _react.cloneElement)(children, _objectSpread(_objectSpread({}, props), {}, {
    ref: (0, _mergeRefs.default)([ref, children.ref])
  }));
});