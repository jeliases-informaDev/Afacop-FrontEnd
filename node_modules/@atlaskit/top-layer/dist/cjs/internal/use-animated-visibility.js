...
exports.useAnimatedVisibility = useAnimatedVisibility;
var _slicedToArray2 = _interopRequireDefault(require("@babel/runtime/helpers/slicedToArray"));
var _react = require("react");
var _bindEventListener = require("bind-event-listener");
var _reducedMotion = require("./reduced-motion");
/**
...
var safetyNetMsMap = {
  dialog: {
    enter: 250,
    // Corresponds to `motion.duration.long`
    exit: 200 // Corresponds to `motion.duration.medium`
  },
  popover: {
    enter: 150,
    // Corresponds to `motion.duration.short`
 ...
 */
function runOnTransitionEndOrTimeout(_ref) {
  var element = _ref.element,
    safetyNetMs = _ref.safetyNetMs,
  ...
  var safetyNetId = setTimeout(settle, safetyNetMs);
  return teardown;
}
 ...
 */
function useAnimatedVisibility(_ref2) {
  var isOpen = _ref2.isOpen,
    animationKind = _ref2.animationKind,
    shouldAnimate = _ref2.shouldAnimate,
    elementRef = _ref2.elementRef,
    onEnterFinish = _ref2.onEnterFinish,
    onExitFinish = _ref2.onExitFinish;
  var willAnimate = shouldAnimate && !(0, _reducedMotion.prefersReducedMotion)();
  ...
  var onEnterFinishRef = (0, _react.useRef)(onEnterFinish);
  onEnterFinishRef.current = onEnterFinish;
  var onExitFinishRef = (0, _react.useRef)(onExitFinish);
  ...
  (0, _react.useEffect)(function () {
    ...
    return runOnTransitionEndOrTimeout({
      element: element,
      safetyNetMs: safetyNetMsMap[animationKind].enter + 50,
      onSettled: function onSettled() {
        var _onEnterFinishRef$cur;
        ...
        // semantics.
        (_onEnterFinishRef$cur = onEnterFinishRef.current) === null || _onEnterFinishRef$cur === void 0 || _onEnterFinishRef$cur.call(onEnterFinishRef);
        setPhase(function (current) {
          return current === 'entering' ? 'open' : current;
        });
      }
    });
  }, [phase, animationKind, elementRef]);
  ...
  var prevPhaseForEntryRef = (0, _react.useRef)('closed');
  (0, _react.useEffect)(function () {
    var prevPhase = prevPhaseForEntryRef.current;
    ...
    if (prevPhase !== 'open' && phase === 'open' && prevPhase !== 'entering') {
      var _onEnterFinishRef$cur2;
      (_onEnterFinishRef$cur2 = onEnterFinishRef.current) === null || _onEnterFinishRef$cur2 === void 0 || _onEnterFinishRef$cur2.call(onEnterFinishRef);
    }
  }, [phase]);
  ...
  (0, _react.useEffect)(function () {
    ...
    return runOnTransitionEndOrTimeout({
      element: element,
      safetyNetMs: safetyNetMsMap[animationKind].exit + 50,
      onSettled: function onSettled() {
        var _onExitFinishRef$curr;
        ...
        (_onExitFinishRef$curr = onExitFinishRef.current) === null || _onExitFinishRef$curr === void 0 || _onExitFinishRef$curr.call(onExitFinishRef);
        setPhase(function (current) {
          return current === 'exiting' ? 'closed' : current;
        });
      }
    });
  }, [phase, willAnimate, animationKind, elementRef]);
  ...
  (0, _react.useLayoutEffect)(function () {
    ...
    return (0, _bindEventListener.bindAll)(element, [{
      type: 'toggle',
  ...
  var prevPhaseForExitRef = (0, _react.useRef)('closed');
  (0, _react.useEffect)(function () {
    var prevPhase = prevPhaseForExitRef.current;
    ...
    if (prevPhase !== 'exiting' && phase === 'exiting' && !willAnimate) {
      var _onExitFinishRef$curr2;
      (_onExitFinishRef$curr2 = onExitFinishRef.current) === null || _onExitFinishRef$curr2 === void 0 || _onExitFinishRef$curr2.call(onExitFinishRef);
    }
  }, [phase, willAnimate]);
  return {
    phase: phase
