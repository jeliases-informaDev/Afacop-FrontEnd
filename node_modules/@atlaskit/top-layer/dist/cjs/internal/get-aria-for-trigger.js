...
exports.getAriaForTrigger = getAriaForTrigger;
var _roleToAriaHasPopup = require("./role-to-aria-has-popup");
/**
 ...
 * ```
 */
function getAriaForTrigger(_ref) {
  var role = _ref.role,
    isOpen = _ref.isOpen,
  ...
  var ariaHasPopup = (0, _roleToAriaHasPopup.roleToAriaHasPopup)({
    role: role
  });
