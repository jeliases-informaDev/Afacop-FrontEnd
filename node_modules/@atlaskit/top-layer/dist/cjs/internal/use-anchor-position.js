...
var _anchorPositioningFallback = require("./anchor-positioning-fallback");
var _combine = require("./combine");
var _placementToPositionArea = require("./placement-to-position-area");
var _placementToTryFallbacks = require("./placement-to-try-fallbacks");
var _resolveCssLengthToPixels = require("./resolve-css-length-to-pixels");
 ...
 */
var NoopResizeObserver = /*#__PURE__*/function () {
  function NoopResizeObserver() {
    (0, _classCallCheck2.default)(this, NoopResizeObserver);
  }
  return (0, _createClass2.default)(NoopResizeObserver, [{
    key: "observe",
 ...
 */
var supportsAnchorPositioning = (0, _once.default)(function () {
 ...
 */
function crossAxisShiftMargin(_ref2) {
  var placement = _ref2.placement,
    crossAxisShiftCssValue = _ref2.crossAxisShiftCssValue,
    direction = _ref2.direction;
  var axis = placement.axis,
    align = placement.align;
  var directionSign = direction === 'forwards' ? 1 : -1;
  var crossAxis = axis === 'block' ? 'inline' : 'block';
  var useEndSide = align === 'end';
  var side = useEndSide ? 'end' : 'start';
  var sideSign = useEndSide ? -1 : 1;
  var finalSign = directionSign * sideSign;
  // Wrap any string in calc() with the sign factor. CSS handles the math.
  var value = finalSign === 1 ? crossAxisShiftCssValue : "calc(-1 * ".concat(crossAxisShiftCssValue, ")");
  return {
    property: "margin-".concat(crossAxis, "-").concat(side),
    value: value
  };
}
 ...
 */
function useStablePlacement(placement) {
  var resolved = (0, _resolvePlacement.resolvePlacement)({
    placement: placement
  });
  var axis = resolved.axis;
  var edge = resolved.edge;
  var align = resolved.align;
  var gap = resolved.offset.gap;
  var shiftValue = resolved.offset.crossAxisShift.value;
  var shiftDirection = resolved.offset.crossAxisShift.direction;
...
function useAnchorPosition(_ref3) {
  var anchorRef = _ref3.anchorRef,
    popoverRef = _ref3.popoverRef,
    _ref3$placement = _ref3.placement,
    placement = _ref3$placement === void 0 ? {} : _ref3$placement,
    _ref3$forceFallbackPo = _ref3.forceFallbackPositioning,
    forceFallbackPositioning = _ref3$forceFallbackPo === void 0 ? false : _ref3$forceFallbackPo,
    _ref3$isEnabled = _ref3.isEnabled,
    isEnabled = _ref3$isEnabled === void 0 ? true : _ref3$isEnabled,
    isOpen = _ref3.isOpen;
  var id = (0, _react.useId)();
  var stablePlacement = useStablePlacement(placement);
  (0, _react.useLayoutEffect)(function () {
    if (!isEnabled) {
      return;
    }
    var trigger = anchorRef.current;
    var popover = popoverRef.current;
    if (!trigger || !popover) {
      return;
    }
    var gapCssValue = stablePlacement.offset.gap;
    var crossAxisShiftCssValue = stablePlacement.offset.crossAxisShift.value;
    var shouldForceFallback = Boolean(forceFallbackPositioning);
    if (supportsAnchorPositioning() && !shouldForceFallback) {
      ...
      var anchorName = trigger.style.getPropertyValue('anchor-name') || "--anchor-".concat(id.replace(/:/g, ''));
      var gap = edgeMargin({
      ...
      var crossAxisShift = crossAxisShiftMargin({
        placement: stablePlacement,
        crossAxisShiftCssValue: crossAxisShiftCssValue,
      ...
      var popoverStyles = [{
        ...
        value: (0, _placementToPositionArea.placementToPositionArea)({
          placement: stablePlacement
        })
      }, {
        property: 'position-try-fallbacks',
        value: (0, _placementToTryFallbacks.placementToTryFallbacks)({
          placement: stablePlacement
        })
      },
      ...
      // with anchor positioning (UA: `inset: 0; margin: auto;`)
      {
        ...
        property: crossAxisShift.property,
        value: crossAxisShift.value
      }];
      ...
      popoverStyles.push({
        property: '--ds-cross-axis-shift-margin-start',
        value: '0px'
      });
      popoverStyles.push({
        property: '--ds-cross-axis-shift-margin-end',
        value: '0px'
      });
      popoverStyles.push({
      ...
      var crossAxisShiftActive = crossAxisShift;
      var customPropertyByMarginProperty = {
      ...
      var crossAxisShiftCustomProperty = customPropertyByMarginProperty[crossAxisShiftActive.property];
      ...
      var _undoPositioning = (0, _combine.combine)((0, _setStyle.setStyle)({
        element: popover,
        styles: popoverStyles
      }));
      return _undoPositioning;
    }

    // JS fallback. The popover is already in the top layer via
    // popover="auto", so we only reset UA defaults and set top/left
    // based on measurements.
    var cleanupBaseStyles = (0, _setStyle.setStyle)({
      element: popover,
      styles: [{
        property: 'margin',
        value: '0'
    ...
    function update() {
      ...
      var gapPx = (0, _resolveCssLengthToPixels.resolveCssLengthToPixels)({
        value: gapCssValue,
        container: popover
      });
      var crossAxisShiftPx = (0, _resolveCssLengthToPixels.resolveCssLengthToPixels)({
        value: crossAxisShiftCssValue,
        container: popover
      });
      var _computeFallbackPosit = (0, _anchorPositioningFallback.computeFallbackPosition)({
        ...
        top = _computeFallbackPosit.top,
        left = _computeFallbackPosit.left;
      popover.style.setProperty('top', "".concat(top, "px"));
      popover.style.setProperty('left', "".concat(left, "px"));
    ...
    var scheduledUpdate = (0, _rafSchd.default)(update);
    ...
    var ResizeObserverImpl = typeof ResizeObserver !== 'undefined' ? ResizeObserver : NoopResizeObserver;
    var resizeObserver = new ResizeObserverImpl(function () {
    ...
    var undoPositioning = (0, _combine.combine)(cleanupBaseStyles,
    ...
    (0, _bindEventListener.bind)(popover, {
      type: 'toggle',
