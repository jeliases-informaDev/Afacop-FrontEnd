...
import { type TAriaRoleRequired, type TRoleRequiringAccessibleName, type TRoleWithImplicitName } from '../internal/role-types';
/**
...
type TPopoverBaseProps = {
     ...
     */
    enteringAnimationXcss?: StrictXCSSProp<'animationName' | 'animationDuration' | 'animationTimingFunction' | 'animationDelay', never>;
    /**
     * Animation styles applied while the popover is exiting.
     *
     * Only applied when `shouldAnimate` is `true`.
     */
    exitingAnimationXcss?: StrictXCSSProp<'animationName' | 'animationDuration' | 'animationTimingFunction' | 'animationDelay', never>;
    /**
 ...
 */
export type TPopoverProps = TPopoverBaseProps & TAriaRoleRequired & ({
    mode?: 'auto' | 'hint';
    /**
