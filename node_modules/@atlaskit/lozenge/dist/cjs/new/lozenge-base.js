/* lozenge-base.tsx generated by @compiled/babel-plugin v2.0.0 */
"use strict";
...
var _new = _interopRequireDefault(require("@atlaskit/badge/new"));
var _css = require("@atlaskit/css");
var _chevronDown = _interopRequireDefault(require("@atlaskit/icon/core/chevron-down"));
var _resizing = require("@atlaskit/motion/resizing");
...
var LozengeBase = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var resizingWidth = (0, _resizing.useResizing)({
    dimension: 'width',
  ...
  var innerContent = /*#__PURE__*/React.createElement("span", (0, _extends2.default)({}, enableMotionFG ? resizingWidth : undefined, {
  ...
  if (isInteractive) {
    return /*#__PURE__*/React.createElement(_pressable.default, (0, _extends2.default)({
      ref: ref,
      xcss: (0, _css.cx)(styles.container, (0, _platformFeatureFlags.fg)('platform-dst-motion-uplift') && styles.motionContainer, spacing === 'spacious' && styles.containerSpacious, !isSelected && styles.iconBorderFilter, styles[colorStyleKey], !isLoading && styles[interactiveStyleKey], hasTrailingMetric && styles.containerBadgePressed, hasTrailingMetric && resolvedTrailingMetricAppearance === 'neutral' && styles.containerBadgeNeutralAppearance)
    }, isLoading && {
      'aria-busy': true,
      'aria-disabled': true,
      isDisabled: true
