...
var _getOptionsWithDefaults = require("./getOptionsWithDefaults");
var _migrateInitializationOptions = require("./migrateInitializationOptions");
...
var _toStatsigUser = require("./toStatsigUser");
  ...
  return (0, _createClass2.default)(Client, [{
      ...
      var _initialize = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(clientOptions, identifiers, customAttributes) {
        ...
        return _regenerator.default.wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              clientOptionsWithDefaults = (0, _getOptionsWithDefaults.getOptionsWithDefaults)(clientOptions);
              if (!this.initPromise) {
                _context.next = 1;
                break;
              }
              if (!(0, _shallowEquals.shallowEquals)(clientOptionsWithDefaults, this.initOptions)) {
      ...
      var _updateUser = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4(fetchOptions, identifiers, customAttributes) {
        ...
        return _regenerator.default.wrap(function (_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              this.assertInitialized(this.statsigClient);
              fetchOptionsWithDefaults = (0, _getOptionsWithDefaults.getOptionsWithDefaults)(fetchOptions);
    ...
    */
    ...
    value: function isCurrentUser(identifiers, customAttributes) {
      return (0, _shallowEquals.shallowEquals)(this.currentIdentifiers, identifiers) && (0, _shallowEquals.shallowEquals)(this.currentAttributes, customAttributes);
    }
    ...
    value: (function () {
      var _init = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee8(clientOptions, identifiers, customAttributes) {
        var fromValuesClientOptions, experimentValues, customAttributesFromResult, clientSdkKeyPromise, experimentValuesPromise, _yield$Promise$all, _yield$Promise$all2, experimentValuesResult, _t;
        return _regenerator.default.wrap(function (_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 4:
              _context8.prev = 4;
              _t = _context8["catch"](2);
              if (_t instanceof Error) {
                // eslint-disable-next-line no-console
                console.error("Error occurred when trying to fetch the Feature Gates client values, error: ".concat(_t === null || _t === void 0 ? void 0 : _t.message));
              }
              // eslint-disable-next-line no-console
    ...
    value: function () {
      var _initWithProvider = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee9(baseClientOptions, provider, identifiers, customAttributes) {
        var fromValuesClientOptions, experimentValues, customAttributesFromResult, clientSdkKeyPromise, experimentValuesPromise, _yield$Promise$all3, _yield$Promise$all4, experimentValuesResult, _t2;
          ...
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 4:
              ...
              if (_t2 instanceof Error) {
                // eslint-disable-next-line no-console
                console.error("Error occurred when trying to fetch the Feature Gates client values, error: ".concat(_t2 === null || _t2 === void 0 ? void 0 : _t2.message));
              }
              // eslint-disable-next-line no-console
              console.warn("Initialising Statsig client without values");
              _context9.next = 5;
        ...
        return _regenerator.default.wrap(function (_context0) {
          while (1) switch (_context0.prev = _context0.next) {
            case 0:
              ...
              newClientOptions = (0, _migrateInitializationOptions.migrateInitializationOptions)(clientOptions);
              ...
              frontendUser = (0, _toStatsigUser.toStatsigUser)(identifiers, customAttributes);
              this.user = (0, _deepAssign.deepAssign)({}, initializeValues.user, frontendUser);
            ...
            case 3:
              ...
              if (_t3 instanceof Error) {
                // eslint-disable-next-line no-console
                console.error("Error occurred when trying to initialise the Statsig client, error: ".concat(_t3 === null || _t3 === void 0 ? void 0 : _t3.message));
              }
              // eslint-disable-next-line no-console
    ...
    value: (function () {
      var _updateUserUsingInitializeValuesProducer = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee10(getInitializeValues, identifiers, customAttributes) {
        var _this9 = this;
        var originalInitPromise, initializeValuesPromise, updateUserPromise, _t4;
    ...
    value: (function () {
      var _updateStatsigClientUser = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee11(initializeValuesPromise, identifiers, customAttributes) {
        ...
        var initializeValues, user, frontendUser, _updateUserCompletion, _ref4, errMsg, success, errorMessage, _t5, _t6;
        return _regenerator.default.wrap(function (_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 2:
              ...
              frontendUser = (0, _toStatsigUser.toStatsigUser)(identifiers, initializeValues.customAttributesFromFetch);
              user = (0, _deepAssign.deepAssign)({}, initializeValues.experimentValues.user, frontendUser);
              _context11.next = 4;
              break;
            case 3:
              _context11.prev = 3;
              _t5 = _context11["catch"](1);
              ...
              errMsg = _t5 instanceof Error ? _t5.message : JSON.stringify(_t5);
            ...
            case 7:
              _context11.prev = 7;
              _t6 = _context11["catch"](5);
              success = false;
              errorMessage = String(_t6);
            case 8:
    ...
    key: "getTargetApp",
    value: function getTargetApp() {
      var _this$initOptions2;
      return (_this$initOptions2 = this.initOptions) === null || _this$initOptions2 === void 0 ? void 0 : _this$initOptions2.targetApp;
    }
