...
export declare const EvaluationReason: {
    readonly Error: 'Error';
    readonly LocalOverride: 'LocalOverride';
    readonly Unrecognized: 'Unrecognized';
    readonly Uninitialized: 'Uninitialized';
    readonly NetworkNotModified: 'NetworkNotModified';
    readonly Network: 'Network';
    readonly InvalidBootstrap: 'InvalidBootstrap';
