/* text.tsx generated by @compiled/babel-plugin v2.0.0 */
"use strict";
...
var _hasTextAncestorProvider = require("../../utils/has-text-ancestor-provider");
var _surfaceProvider = require("../../utils/surface-provider");
var _useHasTextAncestor = require("../../utils/use-has-text-ancestor");
...
var Text = exports.Text = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var hasTextAncestor = (0, _useHasTextAncestor.useHasTextAncestor)();
  ...
  return /*#__PURE__*/React.createElement(_hasTextAncestorProvider.HasTextAncestorProvider, {
    value: true
  }, component);
});