...
var _spaceStylesMap = require("../xcss/space-styles-map");
/**
 * @jsxRuntime classic
 * @jsx jsx
 */
 ...
 * ```
 */
var Grid = exports.Grid = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  var as = _ref.as,
  ...
  return (0, _react2.jsx)(Component, {
    ...
    gap && _spaceStylesMap.spaceStylesMap.gap[gap],
    // eslint-disable-next-line @atlaskit/ui-styling-standard/no-imported-style-values -- Ignored via go/DSP-18766
    columnGap && _spaceStylesMap.spaceStylesMap.columnGap[columnGap],
    // eslint-disable-next-line @atlaskit/ui-styling-standard/no-imported-style-values -- Ignored via go/DSP-18766
    rowGap && _spaceStylesMap.spaceStylesMap.rowGap[rowGap], alignItems && alignItemsMap[alignItems], alignContent && alignContentMap[alignContent], justifyContent && justifyContentMap[justifyContent], autoFlow && gridAutoFlowMap[autoFlow]].concat((0, _toConsumableArray2.default)(resolvedStyles.emotion || [])),
    "data-testid": testId,
    ref: ref
  }, children);
}));
