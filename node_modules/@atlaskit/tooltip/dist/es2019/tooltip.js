...
function Tooltip({
  ...
  const handleOpenLayerObserverCloseSignal = useCallback(() => {
    ...
    (_apiRef$current5 = apiRef.current) === null || _apiRef$current5 === void 0 ? void 0 : _apiRef$current5.requestHide({
      isImmediate: true
    });
  }, []);
