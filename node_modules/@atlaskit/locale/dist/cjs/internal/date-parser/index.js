...
var INVARIANT_DATE = (0, _toDate.toDate)(INVARIANT);
...
var createDateParser = exports.createDateParser = function createDateParser(locale) {
  ...
  return function (date) {
    ...
    var normalizedDate = (0, _normalizeDate.normalizeDate)(extractedDate, options === null || options === void 0 ? void 0 : options.defaultFirstDay);
    if (!(0, _isValid.isValid)(normalizedDate)) {
      return INVALID_DATE;
    }
    return (0, _toDate.toDate)(normalizedDate);
  };
};