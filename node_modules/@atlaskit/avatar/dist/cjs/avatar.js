/* avatar.tsx generated by @compiled/babel-plugin v2.0.0 */
"use strict";
...
var normalizeAvatarSize = function normalizeAvatarSize(size) {
  return size === 'xsmall' && !(0, _platformFeatureFlags.fg)('platform_design-system-team_avatar-remove-xsmall') ? 'xxsmall' : size;
};
...
var Avatar = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var size = normalizeAvatarSize(sizeProp || (context === null || context === void 0 ? void 0 : context.size) || 'medium');
  ...
  var isValidIconSize = size !== 'xxlarge' && size !== 'xxsmall' && size !== 'xsmall';
  ...
  // `isValidIconSize`.
  var indicatorSize = !isValidIconSize ? 'small' : size === 'UNSAFE_xsmall' ? 'small' : size;
