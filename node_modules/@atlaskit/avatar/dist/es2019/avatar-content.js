...
export const AvatarContent = /*#__PURE__*/forwardRef(({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: ax([unboundStyles.hexagonFocusContainer, isInteractive && !isDisabled && fg('platform-dst-motion-uplift') && unboundStyles.interactiveMotion, fg('platform_editor_agent_mentions_drop_one_fixes') && hexagonBorderFixStyles.hexagonFocusContainer])
  }, /*#__PURE__*/React.createElement("div", {
    "data-testid": testId ? `${testId}-hexagon-border-container` : 'hexagon-border-container',
    className: ax([unboundStyles.hexagonBorderContainer, fg('avatar-custom-border') && unboundStyles.hexagonBorderContainerCustomBorder, fg('platform_editor_agent_mentions_drop_one_fixes') && hexagonBorderFixStyles.hexagonBorderContainer])
  }, renderedContent));
});