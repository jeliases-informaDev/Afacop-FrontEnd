...
const normalizeAvatarSize = size => size === 'xsmall' && !fg('platform_design-system-team_avatar-remove-xsmall') ? 'xxsmall' : size;
...
const Avatar = /*#__PURE__*/forwardRef(({
  ...
  const size = normalizeAvatarSize(sizeProp || (context === null || context === void 0 ? void 0 : context.size) || 'medium');
  ...
  // `isValidIconSize`.
  const indicatorSize = !isValidIconSize ? 'small' : size === 'UNSAFE_xsmall' ? 'small' : size;
