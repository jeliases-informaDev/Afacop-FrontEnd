...
var _buttonAppearances = require("./button-appearances");
var _buttonSpacing = require("./button-spacing");
var _iconButtonAppearances = require("./icon-button-appearances");
var _iconButtonShapes = require("./icon-button-shapes");
var _iconButtonSpacing = require("./icon-button-spacing");
var _linkButtonAppearances = require("./link-button-appearances");
...
var variants = {
  Button: {
    ...
    appearances: _buttonAppearances.buttonAppearances,
    spacing: _buttonSpacing.buttonSpacing
  },
  LinkButton: {
    name: 'LinkButton',
    Component: LinkButtonRender,
    elementType: HTMLAnchorElement,
    appearances: _linkButtonAppearances.linkButtonAppearances,
    spacing: _buttonSpacing.buttonSpacing
  },
  IconButton: {
    name: 'IconButton',
    ...
    elementType: HTMLButtonElement,
    appearances: _iconButtonAppearances.iconButtonAppearances,
    spacing: _iconButtonSpacing.iconButtonSpacing,
    shape: _iconButtonShapes.iconButtonShapes
  },
  LinkIconButton: {
    name: 'LinkIconButton',
