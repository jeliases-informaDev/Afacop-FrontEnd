...
var _getContentStyle = require("./get-content-style");
var _getFadingCss = require("./get-fading-css");
var _getIconStyle = require("./get-icon-style");
...
var ButtonBase = /*#__PURE__*/_react.default.forwardRef(function ButtonBase(props, ref) {
  ...
  var fadeStyles = (0, _react2.css)((0, _getFadingCss.getFadingCss)({
  ...
  return (0, _react2.jsx)(_focusRing.default, null, (0, _react2.jsx)(Component, (0, _extends2.default)({}, rest, {
    ...
    (0, _getIconStyle.getIconStyle)({
      spacing: spacing
    }), getSpacingFix(children, iconBeforeSpacingFixStyle)]
  }, iconBefore) : null, getChildren(children, [fadeStyles, (0, _getContentStyle.getContentStyle)({
    spacing: spacing
    ...
    css: [_overlayCss.overlayCss, spinnerHackCss]
  }, overlay) : null));
});
