...
export type ButtonAppearance = 'default' | 'danger' | 'primary' | 'rovo' | 'subtle' | 'warning' | 'discovery';
export type LinkButtonAppearance = 'default' | 'danger' | 'primary' | 'rovo' | 'subtle' | 'warning' | 'discovery';
