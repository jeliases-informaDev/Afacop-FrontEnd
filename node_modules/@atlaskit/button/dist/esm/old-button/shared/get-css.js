...
export function getCss(_ref) {
  ...
  return _objectSpread(_objectSpread({
    ...
    textAlign: 'center',
    textDecoration: 'none',
    transition: fg('platform-dst-motion-uplift-button') ? "var(--ds-button-hovered, background-color 150ms cubic-bezier(0.4, 1, 0.6, 1))".concat(", box-shadow 0.15s cubic-bezier(0.47, 0.03, 0.49, 1.38)") : 'background 0.1s ease-out, box-shadow 0.15s cubic-bezier(0.47, 0.03, 0.49, 1.38)',
    whiteSpace: 'nowrap',
    cursor: 'pointer',
  ...
  }, isSelected ? selectedStyles : _objectSpread(_objectSpread(_objectSpread({}, appearanceStyles), activeStyles && fg('platform-dst-motion-uplift-button') && {
    '&:active': _objectSpread(_objectSpread({}, activeStyles), {}, {
      transition: "var(--ds-button-pressed, background-color 150ms cubic-bezier(0.4, 1, 0.6, 1))"
    })
  }), {}, {
    '&[disabled]': {
