...
var Select = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(Select, [{
    ...
    function renderInput() {
      ...
      var isDisabledA11yFixEnabled = fg('platform_dst_select_disabled_a11y_fix');

      // aria attributes makes the JSX "noisy", separated for clarity
      var ariaAttributes = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, !this.props.isSearchable && fg('platform_fix_autocomplete_aria_for_select') ? {} : {
    ...
    value: function renderPlaceholderOrValue() {
      ...
      return /*#__PURE__*/React.createElement(SingleValue, _extends({}, commonProps, {
        ...
        }, isDisabled && fg('platform_dst_select_disabled_a11y_fix') && {
          'aria-hidden': true
        })
