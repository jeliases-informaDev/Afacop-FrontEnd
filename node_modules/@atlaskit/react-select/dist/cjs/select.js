/* select.tsx generated by @compiled/babel-plugin v2.0.0 */
"use strict";
...
var _dummyInput = _interopRequireDefault(require("./components/dummy-input"));
var _liveRegion = _interopRequireDefault(require("./components/live-region"));
var _menuPlacer = _interopRequireDefault(require("./components/menu-placer"));
...
var _isOptionDisabled2 = require("./is-option-disabled");
...
function scrollIntoView(menuEl, focusedEl) {
  ...
  if (focusedRect.bottom + overScroll > menuRect.bottom) {
    (0, _scrollTo.scrollTo)(menuEl, Math.min(focusedEl.offsetTop + focusedEl.clientHeight - menuEl.offsetHeight + overScroll, menuEl.scrollHeight));
  } else if (focusedRect.top - overScroll < menuRect.top) {
    (0, _scrollTo.scrollTo)(menuEl, Math.max(focusedEl.offsetTop - overScroll, 0));
  }
}
...
var defaultProps = exports.defaultProps = {
  ...
  formatGroupLabel: _formatGroupLabel.formatGroupLabel,
  getOptionLabel: _getOptionLabel.getOptionLabel,
  getOptionValue: _getOptionValue.getOptionValue,
  isDisabled: false,
  isLoading: false,
  isMulti: false,
  isRtl: false,
  isSearchable: true,
  isOptionDisabled: _isOptionDisabled2.isOptionDisabled,
...
var Select = exports.default = /*#__PURE__*/function (_Component) {
  ...
  function Select(_props) {
    ...
    (0, _defineProperty2.default)(_this, "selectOption", function (newValue) {
      ...
      if (deselected) {
        ...
        _this.setValue((0, _multiValueAsValue.multiValueAsValue)(selectValue.filter(function (i) {
          return _this.getOptionValue(i) !== candidate;
        })), 'deselect-option', newValue);
      } else if (!isDisabled) {
        // Select option if option is not disabled
        if (isMulti) {
          _this.setValue((0, _multiValueAsValue.multiValueAsValue)([].concat((0, _toConsumableArray2.default)(selectValue), [newValue])), 'select-option', newValue);
        } else {
          _this.setValue((0, _singleValueAsValue.singleValueAsValue)(newValue), 'select-option');
        }
      } else {
        _this.ariaOnChange((0, _singleValueAsValue.singleValueAsValue)(newValue), {
    ...
    (0, _defineProperty2.default)(_this, "removeValue", function (removedValue) {
      ...
      var newValue = (0, _valueTernary.valueTernary)(isMulti, newValueArray, newValueArray[0] || null);
      _this.onChange(newValue, {
        action: 'remove-value',
    ...
    (0, _defineProperty2.default)(_this, "clearValue", function () {
      var selectValue = _this.state.selectValue;
      _this.onChange((0, _valueTernary.valueTernary)(_this.props.isMulti, [], null), {
        action: 'clear',
    ...
    (0, _defineProperty2.default)(_this, "cx", function () {
      ...
      return _classnames.classNames.apply(void 0, [_this.props.classNamePrefix].concat(args));
    });
    ...
    (0, _defineProperty2.default)(_this, "onScroll", function (event) {
      if (typeof _this.props.closeMenuOnScroll === 'boolean') {
        if (event.target instanceof HTMLElement && (0, _isDocumentEl.isDocumentElement)(event.target)) {
    ...
    _this.state.selectValue = (0, _cleanValue.cleanValue)(_props.value);
  ...
  return (0, _createClass2.default)(Select, [{
    ...
    value: function formatOptionLabel(data, context) {
      ...
      if (context === 'menu' && !this.props.formatOptionLabel && !((_this$props$component = this.props.components) !== null && _this$props$component !== void 0 && _this$props$component.Option) && (0, _platformFeatureFlags.fg)('platform-dst-lozenge-tag-badge-visual-uplifts')) {
        ...
        if (elemBefore) {
          ...
          }, elemBefore, /*#__PURE__*/_react.default.createElement("span", null, label));
        }
      }
    ...
    function renderInput() {
      ...
      var isDisabledA11yFixEnabled = (0, _platformFeatureFlags.fg)('platform_dst_select_disabled_a11y_fix');

      // aria attributes makes the JSX "noisy", separated for clarity
      var ariaAttributes = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, !this.props.isSearchable && (0, _platformFeatureFlags.fg)('platform_fix_autocomplete_aria_for_select') ? {} : {
      ...
      var effectiveTabIndex = isDisabledA11yFixEnabled && isDisabled ? -1 : tabIndex;
      if (!isSearchable) {
        // use a dummy input to maintain focus/blur functionality
        return /*#__PURE__*/_react.default.createElement(_dummyInput.default, (0, _extends2.default)({
          id: id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      return /*#__PURE__*/_react.default.createElement(SingleValue, (0, _extends2.default)({}, commonProps, {
        ...
        }, isDisabled && (0, _platformFeatureFlags.fg)('platform_dst_select_disabled_a11y_fix') && {
          'aria-hidden': true
        })
    ...
    value: function renderMenu() {
      ...
      var menuElement = /*#__PURE__*/_react.default.createElement(_menuPlacer.default, (0, _extends2.default)({}, commonProps, menuPlacementProps), function (_ref4) {
        var ref = _ref4.ref,
        ...
        return /*#__PURE__*/_react.default.createElement(Menu, (0, _extends2.default)({}, commonProps, menuPlacementProps, {
          ...
          isLoading: isLoading,
          placement: placement
        }), /*#__PURE__*/_react.default.createElement(_scrollManager.default, {
    ...
    value: function renderFormField() {
      ...
      if (required && !this.hasValue() && !isDisabled) {
        return /*#__PURE__*/_react.default.createElement(_requiredInput.default, {
          name: name,
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      var options = props.options,
        ...
        isMulti = props.isMulti;
      var selectValue = (0, _cleanValue.cleanValue)(value);
      ...
      if (isFocused && !hasKeptFocus) {
        ...
        newAriaSelection = {
          value: (0, _valueTernary.valueTernary)(isMulti, selectValue, selectValue[0] || null),
          options: selectValue,
