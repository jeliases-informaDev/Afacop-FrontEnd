...
function useCreatable(_ref) {
  ...
  var _restSelectProps$getO = restSelectProps.getOptionValue,
    getOptionValue = _restSelectProps$getO === void 0 ? _getOptionValue.getOptionValue : _restSelectProps$getO,
    _restSelectProps$getO2 = restSelectProps.getOptionLabel,
    getOptionLabel = _restSelectProps$getO2 === void 0 ? _getOptionLabel.getOptionLabel : _restSelectProps$getO2,
  ...
  var newOption = (0, _react.useMemo)(function () {
    return isValidNewOption(inputValue, (0, _cleanValue.cleanValue)(value), propsOptions, {
  ...
  var onChange = (0, _react.useCallback)(function (newValue, actionMeta) {
    ...
    if (valueArray[valueArray.length - 1] === newOption) {
      if (onCreateOption) {
        ...
        propsOnChange((0, _valueTernary.valueTernary)(isMulti, [].concat((0, _toConsumableArray2.default)((0, _cleanValue.cleanValue)(value)), [newOptionData]), newOptionData), newActionMeta);
      }
      return;
    }
