...
Object.defineProperty(exports, "isExtendedElement", {
  enumerable: true,
  get: function get() {
    return _isExtendedElement.isExtendedElement;
  }
});
exports.isStyleElement = isStyleElement;
var _defineProperty2 = _interopRequireDefault(require("@babel/runtime/helpers/defineProperty"));
var _isExtendedElement = require("./is-extended-element");
...
function isStyleElement(node) {
  return (0, _isExtendedElement.isExtendedElement)(node) && node.tagName.toLowerCase() === 'style' && node.hasAttribute('data-cmpld');
}
...
function getInnerCssContent(node) {
  ...
  if (!node.hasChildNodes() || !(0, _isExtendedElement.isExtendedElement)(node)) {
    return [];
  }
  var output = [];
