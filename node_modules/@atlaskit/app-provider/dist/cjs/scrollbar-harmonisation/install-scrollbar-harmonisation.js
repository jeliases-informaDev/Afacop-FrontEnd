...
exports.installScrollbarHarmonisation = installScrollbarHarmonisation;
 ...
 */
function installScrollbarHarmonisation(targetDocument) {
  ...
  var controller = {
    ...
    release: function release() {
      return rootElement.removeAttribute(_constants.SCROLLBAR_HARMONISATION_ATTRIBUTE);
    }
  };
  rootElement.setAttribute(_constants.SCROLLBAR_HARMONISATION_ATTRIBUTE, '');
