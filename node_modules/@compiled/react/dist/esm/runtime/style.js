...
import insertRule, { getStyleBucketName, insertNonAtomicRule, styleBucketOrdering, } from './sheet.js';
    ...
    if (props.children.length) {
        if (isServerEnvironment()) {
            ...
            for (let i = 0; i < props.children.length; i++) {
                ...
                const bucketName = isNonAtomicSheet(sheet) ? '' : getStyleBucketName(sheet);
