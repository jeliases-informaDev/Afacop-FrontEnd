...
export default function NotificationCenter() {
  ...
  useEffect(() => {
    ...
    socket.on('ficha_completed', (data) => {
      ...
      refreshData({ type: 'ficha_completed', ...data });
    });
    socket.on('evidence_created', (data) => {
      refreshData({ type: 'evidence_created', ...data });
    });
    socket.on('advisor_location', (data) => refreshData({ type: 'advisor_location', ...data }));
