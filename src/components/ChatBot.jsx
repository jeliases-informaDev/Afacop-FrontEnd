...
const ChatBot = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const botContent = contextExtra
        ? `Encontré información: ${contextExtra}`
        : 'Estoy en modo demo. Conecta el backend para respuestas en tiempo real.';
  ...
  return (
    <>
      ...
      <div className="chat-widget" style={{ position: 'fixed', bottom: '30px', right: '30px', zIndex: 9999, fontFamily: 'Poppins, sans-serif', display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'flex-end' }}>
      ...
      {isOpen && (
        <div className="chat-widget-panel" style={{ position: 'absolute', bottom: '80px', right: '0', width: '380px', height: '520px', backgroundColor: 'var(--c-surface)', borderRadius: '24px', border: '1px solid var(--c-border)', display: 'flex', flexDirection: 'column', overflow: 'hidden', boxShadow: 'var(--shadow-lg)' }}>
