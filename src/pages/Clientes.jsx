          ...
          <div className="client-import-modal">
            ...
            <div className="client-import-body">
              ...
              <div className="client-import-columns" aria-label="Columnas incluidas">
                ...
                <div>
                  {['dni *', 'nombres *', 'apellido_paterno', 'apellido_materno', 'telefono', 'direccion', 'distrito', 'estado', 'deuda_castigada', 'deuda_vigente', 'otras_deudas', 'ultima_gestion', 'ubicacion', 'producto', 'linea_credito', 'estado_admision', 'fecha_admision'].map(column => <span key={column}>{column}</span>)}
                </div>
